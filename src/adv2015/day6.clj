...
(defn day-5-p-1 [lines]	
	(get (frequencies (flatten (lights-fun func-part1 lines 1000))) 1))
  
(defn  day-5-p-2 [lines] 
	(reduce + (flatten  (lights-fun func-part2 lines 1000))))
  
(defn get-answer [path-to-file]
	(let [lines (str/split-lines (slurp path-to-file))]
	(println "Answer for first part is: " (day-5-p-1 lines))
	(println "Answer for second part is: " (day-5-p-2 lines))))  
